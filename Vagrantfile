...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    sudo mkdir -p /opt
    cd /opt
    wget -q https://swift.org/builds/swift-3.1-branch/ubuntu1604/swift-3.1-DEVELOPMENT-SNAPSHOT-2017-02-10-a/swift-3.1-DEVELOPMENT-SNAPSHOT-2017-02-10-a-ubuntu16.04.tar.gz
    wget -q https://swift.org/builds/swift-3.1-branch/ubuntu1604/swift-3.1-DEVELOPMENT-SNAPSHOT-2017-02-10-a/swift-3.1-DEVELOPMENT-SNAPSHOT-2017-02-10-a-ubuntu16.04.tar.gz.sig
    gpg --verify swift-*.tar.gz.sig
    tar xzf /opt/swift*.tar.gz
    sudo chown -R vagrant:vagrant /opt
    rm -f swift-*.tar.gz*
    echo "export PATH=/opt/swift-3.1-DEVELOPMENT-SNAPSHOT-2017-02-10-a-ubuntu16.04/usr/bin:\${PATH}" >> ~vagrant/.bashrc
  SHELL
end
